...
def parse_options():
    ...
    parser.add_argument('-i', '--input', help='The dir path of input', type=str,
                        default='/data/bhtian2/win_linux_mapping/Adversarial_Reprogramming-master/datasets/d2a/train/bins/Vul')
...
def main():
    # joern_path = '/data/bhtian2/win_linux_mapping/devign/joern/joern-cli'
