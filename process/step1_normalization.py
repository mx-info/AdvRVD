...
def parse_options():
    ...
    parser.add_argument('-i', '--input', default='/data/bhtian2/win_linux_mapping/Adversarial_Reprogramming-master/datasets/d2a/train/', help='The dir path of input dataset', type=str, required=False)
